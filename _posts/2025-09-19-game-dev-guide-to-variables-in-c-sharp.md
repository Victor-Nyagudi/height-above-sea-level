...
A [string]({{ site.baseurl }}/c#/game-dev-guide-to-strings-in-c-sharp) is written using two double quotes (") and, optionally, characters between them. Strings in C# are used to work with text.
