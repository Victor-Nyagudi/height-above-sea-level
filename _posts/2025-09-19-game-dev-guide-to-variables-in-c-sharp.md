...
A [string]({{ site.baseurl }}{% post_url 2025-09-27-game-dev-guide-to-strings-in-c-sharp %}) is written using two double quotes (") and, optionally, characters between them. Strings in C# are used to work with text.
